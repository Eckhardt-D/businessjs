 ...
 */
Fin.prototype.futureValue = function(presentValue, interest, numPeriods = 1, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.presentValue = function(futureValue, interest, numPeriods = 1, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.numPeriods = function(presentValue, futureValue, interest, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.interest = function(presentValue, futureValue, numPeriods = 1, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.futureValueAnnuityDue = function(payment, interest, numPeriods = 1, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.futureValueAnnuityAdvance = function(payment, interest, numPeriods = 1, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.presentValueAnnuityDue = function(payment, interest, numPeriods = 1, perPeriod = 1) {
 ...
 * @param {Number} [perPeriod=1] How many times interest compounds in a period
 */
Fin.prototype.presentValueAnnuityAdvance = function(payment, interest, numPeriods = 1, perPeriod = 1) {
